...
do
    ...
    local WatermarkOuter = Library:Create('Frame', {
        BorderColor3 = Color3.new(0, 0, 0);
        Position = UDim2.new(0.5, -900, 0, 10);
    ...
    Library:GiveSignal(RenderStepped:Connect(function(Delta)
        WatermarkGradientRotation = WatermarkGradientRotation + (Delta * 50)
        if WatermarkGradientRotation >= 360 then
            WatermarkGradientRotation = 0
        end
...
function Library:SetWatermark(Text)
    ...
    Library.Watermark.Size = UDim2.new(0, X + 10, 0, (Y * 1.5) + 5);
...
function Library:CreateWindow(...)
    ...
    Library:GiveSignal(RenderStepped:Connect(function(Delta)
        GradientRotation = GradientRotation + (Delta * 50)
    ...
    function Window:AddTab(Name)
        ...
        function Tab:AddGroupbox(Info)
            ...
            local BoxOuter = Library:Create('Frame', {
                ...
                ZIndex = 2;
                Parent = Info.Side == 1 and LeftSide or Info.Side == 3 and MiddleSide or RightSide;
            });
            Library:Create('UICorner', {
                CornerRadius = UDim.new(0, 4);
                Parent = BoxOuter;
